...
export function Alerts(){
    return(
        <div className="flex fixed items-center bg-black w-full h-10 z-10 gap-5 justify-between px-20 text-xs">
            ...
            <button className="flex items-center">
                ...
                <a href="https://simmonscasaorner.quizclass.net/encontre-seu-colchao-ideal" target="blank">
